    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-sm-12 col-md-8 col-lg-4">
              <div style="text-align: center; font-size: 25px; margin-bottom: 20px;">Login</div>
            <div class="card-body">
              <form novalidate @submit.prevent="loginUser">
                ...
                <button class="btn form-control" style="background-color: black; border-radius: 3.0em; color: white;">
                  Login
                </button>
              </form>
            </div>
